...
public class GridDebug : MonoBehaviour
{
    ...
    private void DisplayCell(Cell cell)
    {
        ...
        iconGO.transform.position = cell.position + curFlowField.OriginPos;
    ...
    private void OnDrawGizmos()
    {
        ...
        switch (curDisplayType)
        {
            case FlowFieldDisplayType.CostField:
                ...
                foreach (Cell curCell in curFlowField.grid)
                {
                    Handles.Label(curCell.position + curFlowField.OriginPos, curCell.cost.ToString(), style);
                }
                break;
            ...
            case FlowFieldDisplayType.IntegrationField:
                ...
                foreach (Cell curCell in curFlowField.grid)
                {
                    Handles.Label(curCell.position + curFlowField.OriginPos, curCell.bestCost.ToString(), style);
                }
                break;
    ...
    private void DrawGrid(Vector2Int drawGridSize, Color drawColor, float drawCellRadius)
    {
        ...
        for (int x = 0; x < drawGridSize.x; x++)
        {
            ...
            {
                Vector3 center = new Vector3(drawCellRadius * 2 * x + drawCellRadius, 0, drawCellRadius * 2 * y + drawCellRadius) + curFlowField.OriginPos;
