...
public class LobbyManager : MonoBehaviour
{
    ...
    public const string KEY_START_GAME = "KeyStartGame";
    ...
    public async void Authenticate(string playerName, Action OnAuthenticated)
    {
    ...
    public async void CreateLobby(string lobbyName)
    {
        ...
        CreateLobbyOptions options = new CreateLobbyOptions
        {
            ...
            Data = new Dictionary<string, DataObject> {
                { KEY_GAME_MODE, new DataObject(DataObject.VisibilityOptions.Public, GameMode.CaptureTheFlag.ToString()) },
